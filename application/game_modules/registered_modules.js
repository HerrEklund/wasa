/**
 * Add the game_id (directory name) to this file to have the game show up
 * in the Wasa Game Library.
 *
 */
...
var registered_modules = [
    ...
    },
    {
        ...
        'box_front': './game_modules/red_winter/components/vassal/splash.png',
    ...
    },
    {
        ...
        'comment': 'Working, but with only the first map and scenario.'
    },
    {
        'game_id': 'sjw',
    ...
    },
    {
        ...
        'comment': 'Probably fully working but not yet tested.'
    },
    {
        ...
        'comment': 'Card deck exists in game but cards can not be drawn or shuffled correctly yet. ' +
            'Counter would need to be flippable and a chit-pull mechanic is needed for set set-up. Still' +
            'quite usable to fiddle around with the game.'
    },
    {
